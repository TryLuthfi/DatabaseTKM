            ...
            <a>
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span style="color:blue" class="info-box-text">1. NY PROGRESS</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <a>
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                   <span style="color:blue" class="info-box-text">2. OGP CANVASING</span>
                   <span style="color:blue" class="info-box-number">
                     10.829 ( HP )
                   </span>
                </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <a>
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <span style="color:blue" class="info-box-text">3. OGP BAK</span>
                  <span style="color:blue" class="info-box-number">
                    829 ( HP )
                  </span>
                </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <a>
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <span style="color:blue" class="info-box-text">4. CBN APPROVED</span>
                  <span style="color:blue" class="info-box-number">
                    2829 ( HP )
                  </span>
                </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <a>
              <div class="info-box mb-3">
                <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-search-dollar"></i></span>
                <div class="info-box-content">
                  <span style="color:blue" class="info-box-text">5. WAITING SPK</span>
                  <span style="color:blue" class="info-box-number">
                    209 ( HP )
                  </span>
                </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <a>
              <div class="info-box mb-3">
                <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-search-dollar"></i></span>
                <div class="info-box-content">
                  <span style="color:blue" class="info-box-text">6. OGP HLD</span>
                  <span style="color:blue" class="info-box-number">
                    1.229 ( HP )
                  </span>
                </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <a>
              <div class="info-box mb-3">
                <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-search-dollar"></i></span>
                <div class="info-box-content">
                  <span style="color:blue" class="info-box-text">7. OGP LLD</span>
                  <span style="color:blue" class="info-box-number">
                    229 ( HP )
                  </span>
                </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <a>
              <div class="info-box mb-3">
                <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-search-dollar"></i></span>
                <div class="info-box-content">
                  <span style="color:blue" class="info-box-text">8. DONE RFS</span>
                  <span style="color:blue" class="info-box-number">
                    1.889 ( HP )
                  </span>
                </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <a>
              <div class="info-box mb-3">
                <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-search-dollar"></i></span>
                <div class="info-box-content">
                  <span style="color:blue" class="info-box-text">9. OGP ATP</span>
                  <span style="color:blue" class="info-box-number">
                    982 ( HP )
                  </span>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div  class="col-6">
                                ...
                                <div class="col-5">
                                    <a href="#" class="btn btn-success float-right text-bold" data-target="#modal-lg-tambah-manual" data-toggle="modal">Tambah &nbsp;<i class="fas fa-plus"></i> </a>
                                </div>
                                <div class="col-1">
                                    <a href="#" class="btn btn-success float-right text-bold" data-target="#modal-lg-tambah-file" data-toggle="modal">File &nbsp;<i class="fas fa-plus"></i> </a>
                                </div>
                            </div>
                            ...
                            <table id="tabel_pemasukan" class="table table-bordered table-striped">
                                    ...
                                    foreach ($rincian as $data) :
                                     ...
                                     ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $data['realisasi_tiang_project_fiberstar_progress'] ?> / <?= $data['plan_tiang_project_fiberstar_progress'] ?></td>
                                            <td><?= $data['realisasi_kabel_project_fiberstar_progress'] ?> / <?= $data['plan_kabel_project_fiberstar_progress'] ?></td>
                                            <td><?= $data['realisasi_fat_project_fiberstar_progress'] ?> / <?= $data['plan_fat_project_fiberstar_progress'] ?></td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th colspan="1"><?= number_format($jumlah_hp, 0, ',', '.') ?></th>
                                        <th colspan="1"><?= number_format($jumlah_tiang, 0, ',', '.') ?></th>
                                        <th colspan="1"><?= number_format($jumlah_kabel, 0, ',', '.') ?></th>
                                        <th colspan="1"><?= number_format($jumlah_fat, 0, ',', '.') ?></th>
                                        <th colspan="2"></th>
                                    </tr>
                                </tfoot>
                            </table>
