...
FROM
	tb_logistik_pesanan_pabrik
LEFT JOIN tb_master_logistik_pabrik ON
	tb_logistik_pesanan_pabrik.id_pabrik = tb_master_logistik_pabrik.id_pabrik
LEFT JOIN tb_master_logistik_kode_item ON
	tb_logistik_pesanan_pabrik.id_kode_item = tb_master_logistik_kode_item.id_kode_item
LEFT JOIN tb_master_user ON
	tb_logistik_pesanan_pabrik.id_user = tb_master_user.id_user
LEFT JOIN tb_logistik_pengiriman_pabrik USING(nomor_po_pabrik)
GROUP BY
	tb_logistik_pesanan_pabrik.nomor_po_pabrik,
	tb_logistik_pesanan_pabrik.qty_material_pesanan;')
            ->result_array();
        return $data;
    }
