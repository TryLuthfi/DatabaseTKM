                        ...
                        <form action="<?= base_url('StockOpname/inputSO') ?>" method="post" id="form-so" enctype="multipart/form-data">
                            ...
                            <div class="card-body table-scrollable">
                                ...
                                <div class="modal-footer">
                                    <a href="<?php echo site_url('Fiberstar_Project_Detail/editStatusImplementasiBack/'); ?>"
                                        class="btn btn-primary float-right text-bold">Simpan Stock Opname</a>
                                </div>
                            </div>
                                                </form>
                        </div>
