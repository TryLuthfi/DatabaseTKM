                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="p-3 mb-4 shadow-sm rounded"
                                                    ...
                                                    <h4 class="text-center mb-4 font-weight-bold text-primary">TIPE 1
                                                    </h4>
                                                    <div class="row">
                                                        <?php foreach ($getCountAsetTerminasiAll as $stokTerminasi): ?>
                                                            <?php if ($stokTerminasi['ka_sorting'] == 1): ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="p-3 mb-4 shadow-sm rounded"
                                                    style="background-color: #bbc1c754;">
                                                    <h4 class="text-center mb-4 font-weight-bold text-primary">TIPE 2
                                                    </h4>
                                                    <div class="row">
                                                        <?php foreach ($getCountAsetTerminasiAll as $stokTerminasi): ?>
                                                            <?php if ($stokTerminasi['ka_sorting'] == 2): ?>
                                                                <div class="col-lg-3 col-12 mb-3">
                                                                    <div class="small-box bg-info">
                                                                        <div class="inner">
                                                                            <h3><?= number_format($stokTerminasi['total_data'], 0, ",", ".") ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="p-3 mb-4 shadow-sm rounded"
                                                    style="background-color: #bbc1c754;">
                                                    <h4 class="text-center mb-4 font-weight-bold text-primary">TIPE 3
                                                    </h4>
                                                    <div class="row">
                                                        <?php foreach ($getCountAsetTerminasiAll as $stokTerminasi): ?>
                                                            <?php if ($stokTerminasi['ka_sorting'] == 3): ?>
                                                                <div class="col-lg-3 col-12 mb-3">
                                                                    <div class="small-box bg-info">
                                                                        <div class="inner">
                                                                            <h3><?= number_format($stokTerminasi['total_data'], 0, ",", ".") ?>
