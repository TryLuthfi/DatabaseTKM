...
<div class="content-wrapper">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach ($getCountAlatTerminasiByRegionTipe1 as $data):
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            ?></td>
                                                                            <td>
                                                                                <a href="<?php echo site_url('GA_Alat_Terminasi/detailOfficeArea/' . $data['at_regional']); ?>"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach ($getCountAlatTerminasiByCityTipe1 as $data):
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            ?></td>
                                                                            <td>
                                                                                <a href="<?php echo site_url('GA_Alat_Terminasi/detailOfficeArea/' . $data['at_area']); ?>"
                                                                                    class="btn btn-primary"><i
                                                                                        class=" fas fa-eye"></i></a>
                                                                            </td>
                                                                        </tr>
    ...
    <script>
        ...
        $('#btnFilterDataProject').on('click', function () {
            ...
            $.ajax({
                url: '<?php echo site_url("GA_Alat_Terminasi/filterDataProject"); ?>',
                type: 'POST',
                data: filterData,
                dataType: 'json',
