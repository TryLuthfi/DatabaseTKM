            ...
            <div class="row clearfix hidden-md-up">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex p-0">
                            <h3 class="card-title p-3">LIST PR AREA</h3>
                            <ul class="nav nav-pills ml-auto p-2 pr-3">
                                <li class="nav-item"><a href="#" class="btn btn-success text-bold btn_tambah_pr"
                                        data-target="#modal_tambah_pr" data-toggle="modal">Tambah Purchase
                                        Request</i></a></li>
                            </ul>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($list_purchase_request_area as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <?php } else { ?>
                                                <td><span class="badge badge-warning">Waiting Approval
                                                        <?= rtrim(($value['approved_planning'] != 1 ? 'Planning, ' : '') . ($value['approved_finance'] != 1 ? 'Finance, ' : '') . ($value['approved_direktur'] != 1 ? 'Direktur, ' : ''), ', ') ?></span>
                                                </td>
                                            <?php } ?>
                                            <!-- <td>Belum Upload Dokumen</td> -->
                                            <td>
                                                <a class="btn btn-danger btn-delete-purchase-request"
                                                    href="javascript:void(0);"
                                                    data-id="<?= $value['id_purchase_request'] ?>"><i
                                                        class="fa fa-trash"></i></a>
                                                <a class="btn btn-primary ml-2"
                                                    href="<?= base_url('Logistik_Purchase_Request/view_purchase_request') . '/' . $value['id_purchase_request'] ?>"><i
                                                        class="fa fa-eye"></i></a>
                                                <a class="btn btn-warning ml-2"><i class="fa fa-print"></i></a>
                                                <a class="btn btn-warning ml-2"
                                                    href="<?= base_url('Logistik_Purchase_Request/edit_purchase_request') . '/' . $value['id_purchase_request'] ?>"
                                                    <?= $this->session->userdata('validation') != 'Planning' ? 'hidden' : '' ?>>Planning <i class="fa fa-edit ml-1"></i></a>
                                            </td>
                                        </tr>
                            ...
                            <div class="modal fade" id="modal_tambah_pr" data-backdrop="static">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        <form action="<?= base_url('Logistik_Purchase_Request/add_purchase_request') ?>"
                                            method="post" id="tambah_purchase_reqeust" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="nomor_pr"
                                                                id="nomor_pr" placeholder="TEC.001/TKM-SK/PR/I/2025"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control"
                                                                name="tanggal_upload_pr" autocomplete="off"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="nama_bowher" id="nama_bowher"
                                                                class="form-control">
                                                                <option value="">Pilih Salah Satu</option>
                                                                <?php foreach ($get_master_project as $key => $value) { ?>
                                                                    <option value="<?= $value['nama_bowheer'] ?>"
                                                                        data-id-bowheer="<?php echo $value['nama_bowheer'] ?>">
                                                                        <?= $value['nama_bowheer'] ?>
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="lokasi_project" id="lokasi_project"
                                                                class="form-control">
                                                                <option value="">Pilih Salah Satu</option>
                                                                <?php foreach ($list_master_gudang as $key => $value) { ?>
                                                                    <option value="<?= $value['id_lokasi_gudang'] ?>">
                                                                        <?= $value['kota_lokasi_gudang'] ?>
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="nama_project"
                                                                id="nama_project" placeholder="Fiberisasi">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="col-form-label">Nomor SP</label>
                                                            <input type="text" class="form-control" name="nomor_sp"
                                                                id="nomor_sp" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="col-form-label">Tanggal Estimasi
                                                                Pengiriman</label>
                                                            <input type="date" class="form-control"
                                                                name="tanggal_pengiriman" autocomplete="off"
                                                                value="<?php echo (new \DateTime())->format('Y-m-d'); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="nama_material" id="nama_material"
                                                                class="form-control">
                                                                <option value="">Pilih Salah Satu</option>
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-bordered"
                                                            id="table_item_purchase_request">
                                                            <thead>
                                                                <tr>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary">Tambah Purchase
                                                    Request</button>
                                            </div>
                                        </form>
                                    </div>
                ...
                <?php if ($this->session->userdata('lokasi_user') == 'HO') { ?>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex p-0">
                                <h3 class="card-title p-3">LIST PR HEAD OFFICE</h3>
                            </div>
                            <div class="card-body">
