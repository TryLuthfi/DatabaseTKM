...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 ">
                    <h1 class="m-0 text-dark" style="text-align: center;">MASTER AKUN BIAYA</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
        ...
        <form action="<?php echo site_url('Budget_MasterAkunBiaya/addMasterBudget'); ?>" method="post">
        ...
        <form action="<?php echo site_url('Budget_MasterAkunBiaya/editMasterBudget'); ?>" method="post">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#btnFilterDataProject').on('click', function (e) {
                ...
                $.ajax({
                    url: '<?= base_url("Budget_MasterAkunBiaya/getFilteredBudget_MasterAkunBiayaAjax") ?>',
                    type: 'POST',
                    data: filters,
                    dataType: 'json',
                    beforeSend: function () {
                    ...
                    success: function (response) {
                        ...
                        <td class="text-center">
                            <a href="<?= site_url('Budget_MasterAkunBiaya/hapusMasterBudget/') ?>${row.id_mab}"
   ...
   data-pic="${row.mab_pic}">
    <i class="fas fa-edit"></i>
        ...
        function updateDashboardFromFooter() {
            ...
            animateValue('dashboardBudget_MasterAkunBiaya', 0, totalTarget, 600, true);
            ...
            $("form").on("submit", function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "<?= base_url('Budget_MasterAkunBiaya/addMasterBudget') ?>",
                            type: "POST",
                            data: formData,
                            dataType: "json",
                            success: function (res) {
                                ...
                                if (res.status === 'not_found') {
                                    Swal.fire({
                                        ...
                                        if (r.isConfirmed) {
                                            $.ajax({
                                                url: "<?= base_url('Budget_MasterAkunBiaya/createNewTargetInvoice') ?>",
                                                type: "POST",
                                                dataType: "json",
                                                data: res,
