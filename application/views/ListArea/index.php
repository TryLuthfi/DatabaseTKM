          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-6">
                  <a href="#" class="btn btn-success float-right text-bold" data-target="#modal-lg-tambah"
                ...
                <tbody>
                  ...
                  foreach ($area as $data):
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('ListArea/delete/' . $data['id_area']); ?>" id="tombol_hapus"
                          class="btn btn-danger tombol_hapus"><i class=" fas fa-trash"></i></a>
                        <a href="#" class="btn btn-warning" data-target="#modal-lg-edit<?= $data['id_area'] ?>"
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="provinsi_area" autocomplete="off"
                        placeholder="Nama Provinsi">
                    </div>
                    <div class="form-group">
                      <label class="col-form-label">Kota</label>
                      <input type="text" class="form-control" name="kota_area" autocomplete="off"
                        placeholder="Nama Kota">
                    </div>
                    <div class="form-group">
                      <label class="col-form-label">Kecamatan</label>
                      <input type="text" class="form-control" name="kecamatan_area" autocomplete="off"
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="form-group">
                        ...
                        <select name="regional_area" class="form-control">
                          <option value="1" <?php if ($data['regional_area'] == '1') { ?>selected <?php } ?>>Regional I
                          </option>
                          <option value="2" <?php if ($data['regional_area'] == '2') { ?>selected <?php } ?>>Regional II
                          </option>
                          <option value="3" <?php if ($data['regional_area'] == '3') { ?>selected <?php } ?>>Regional III
                          </option>
                          <option value="4" <?php if ($data['regional_area'] == '3') { ?>selected <?php } ?>>Regional IV
                          </option>
                          <option value="5" <?php if ($data['regional_area'] == '3') { ?>selected <?php } ?>>Regional V
                          </option>
                        </select>
                      </div>
                      <div class="form-group">
                        <label class="col-form-label">Provinsi</label>
                        <input type="text" class="form-control" name="provinsi_area" autocomplete="off"
                          value="<?= $data['provinsi_area'] ?>">
                      </div>
                      <div class="form-group">
                        <label class="col-form-label">Kota</label>
                        <input type="text" class="form-control" name="kota_area" autocomplete="off"
                          value="<?= $data['kota_area'] ?>">
                      </div>
                      <div class="form-group">
                        <label class="col-form-label">Kecamatan</label>
                        <input type="text" class="form-control" name="kecamatan_area" autocomplete="off"
                          value="<?= $data['kecamatan_area'] ?>">
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Batal</button>
