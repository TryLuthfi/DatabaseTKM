                    ...
                    <div class="tab-content border-left border-right border-bottom p-3">
                        ...
                        <div class="tab-pane fade" id="quick-tab-batch" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="col-md-3"><div class="form-group"><label>Nominal Pencairan Finance</label><input type="number" name="nominal_release_finance" class="form-control" value="<?= myrepQuickValue($quickUpdateData, 'nominal_release_finance') ?>" step="0.01"></div></div>
