...
class GA_Seragam_Kantor extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('MGA_Seragam_Kantor');
    }
    ...
    public function index()
    {
        if (!empty($this->session->userdata('id_user'))) {
            ...
            $data['getMasterAsetOffice'] = $this->MGA_Seragam_Kantor->getMasterAsetOffice();
            $data['getCountAlatTerminasiByRegionTipe1'] = $this->MGA_Seragam_Kantor->getCountAlatTerminasiByRegionTipe1();
            $data['getCountAlatTerminasiByRegionTipe2'] = $this->MGA_Seragam_Kantor->getCountAlatTerminasiByRegionTipe2();
            $data['getCountAlatTerminasiByCityTipe1'] = $this->MGA_Seragam_Kantor->getCountAlatTerminasiByCityTipe1();
            $data['getCountAlatTerminasiByCityTipe2'] = $this->MGA_Seragam_Kantor->getCountAlatTerminasiByCityTipe2();
            $data['getCountAsetOfficeByKota'] = $this->MGA_Seragam_Kantor->getCountAsetOfficeByKota();
            $data['getReportStokAsetkantor'] = $this->MGA_Seragam_Kantor->getReportStokAsetkantor();

            $data['getCountAlatTerminasiAll'] = $this->MGA_Seragam_Kantor->getCountAlatTerminasiAll();
            ...
            $data['getFilteredAlatTerminasi'] = $this->MGA_Seragam_Kantor->getFilteredAlatTerminasi($regional, $area, $tahun, $kondisi, $status);

            $this->load->view('Templates/01_Header', $data);
            $this->load->view('Templates/02_Menu');
            $this->load->view('GA_Seragam_Kantor/index', $data);
    ...
    ini_set('display_errors', 0);
        ...
        $result = $this->MGA_Seragam_Kantor->getFilteredAlatTerminasi($regional, $area, $status, $kondisi, true);
    ...
    public function detailOfficeArea()
    {
        ...
        if (!empty($this->session->userdata('id_user'))) {
            ...
            $data['getCountAsetOfficeAll'] = $this->MGA_Seragam_Kantor->getCountAsetOfficeAll();
            $data['getMasterAsetOffice'] = $this->MGA_Seragam_Kantor->getMasterAsetOffice();
            $data['getMasterAsetOfficeArea'] = $this->MGA_Seragam_Kantor->getMasterAsetOfficeArea();
            $data['getCountAsetOfficeByKota'] = $this->MGA_Seragam_Kantor->getCountAsetOfficeByKota();

            $this->load->view('Templates/01_Header', $data);
            $this->load->view('Templates/02_Menu');
            $this->load->view('GA_Seragam_Kantor/indexofficearea', $data);
            // $this->load->view('Templates/03_Footer');
            $this->load->view('Templates/99_JS');
    ...
    public function detailOffice()
    {
        ...
        if (!empty($this->session->userdata('id_user'))) {
            ...
            $data['filterURL'] = $decoded_url_area;
            $data['getMasterAsetOffice'] = $this->MGA_Seragam_Kantor->getMasterAsetOffice();
            $data['getMasterAsetOfficeTipe'] = $this->MGA_Seragam_Kantor->getMasterAsetOfficeTipe();

            $this->load->view('Templates/01_Header', $data);
            $this->load->view('Templates/02_Menu');
            $this->load->view('GA_Seragam_Kantor/indexoffice', $data);
            // $this->load->view('Templates/03_Footer');
            $this->load->view('Templates/99_JS');
    ...
    public function tambahAsetKantor()
    {
        ...
        $res = $this->MGA_Seragam_Kantor->tambahAsetKantor($hasil_data);
    ...
    public function editAsetKantor($ao_id_list_office)
    {
        ...
        $res = $this->MGA_Seragam_Kantor->editAsetKantor($hasil_data, $where);
    ...
    public function hapusAsetKantor($ao_id_list_office)
    {
        ...
        $res = $this->MGA_Seragam_Kantor->hapusAsetKantor($ao_id_list_office);
