                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-responsive">
                                <table id="tabel_targetbowheer_filter_city1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th rowspan="3"
                                                ...
                                                No</th>
                                            <th rowspan="3"
                                                style="min-width: 100px; text-align:center; vertical-align: middle; background-color: darkslategray; color: #ffffff;">
                                                KOTA</th>
                                            <th rowspan="3"
                                    ...
                                    <tbody>
                                        <?php $no = 1;
                                        foreach ($getTargetWeekFilterCity as $data):
                                            ...
                                            <tr>
                                                ...
                                                <td><?= ($deviasi != 0 ? number_format(floatval($deviasi), 0, ",", ".") : '-') ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                    <tfoot>
