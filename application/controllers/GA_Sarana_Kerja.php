...
class GA_Sarana_Kerja extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('MGA_Sarana_Kerja');
    }
    ...
    public function index()
    {
        if (!empty($this->session->userdata('id_user'))) {
            ...
            $data['getMasterAsetOffice'] = $this->MGA_Sarana_Kerja->getMasterAsetOffice();
            $data['getCountAlatTerminasiByRegionTipe1'] = $this->MGA_Sarana_Kerja->getCountAlatTerminasiByRegionTipe1();
            $data['getCountAlatTerminasiByRegionTipe2'] = $this->MGA_Sarana_Kerja->getCountAlatTerminasiByRegionTipe2();
            $data['getCountAlatTerminasiByCityTipe1'] = $this->MGA_Sarana_Kerja->getCountAlatTerminasiByCityTipe1();
            $data['getCountAlatTerminasiByCityTipe2'] = $this->MGA_Sarana_Kerja->getCountAlatTerminasiByCityTipe2();
            $data['getCountAsetOfficeByKota'] = $this->MGA_Sarana_Kerja->getCountAsetOfficeByKota();
            $data['getReportStokAsetkantor'] = $this->MGA_Sarana_Kerja->getReportStokAsetkantor();

            $data['getCountAlatTerminasiAll'] = $this->MGA_Sarana_Kerja->getCountAlatTerminasiAll();
            ...
            $data['getFilteredAlatTerminasi'] = $this->MGA_Sarana_Kerja->getFilteredAlatTerminasi($regional, $area, $tahun, $kondisi, $status);

            $this->load->view('Templates/01_Header', $data);
            $this->load->view('Templates/02_Menu');
            $this->load->view('GA_Sarana_Kerja/index', $data);
    ...
    ini_set('display_errors', 0);
        ...
        $result = $this->MGA_Sarana_Kerja->getFilteredAlatTerminasi($regional, $area, $status, $kondisi, true);
    ...
    public function detailOfficeArea()
    {
        ...
        if (!empty($this->session->userdata('id_user'))) {
            ...
            $data['getCountAsetOfficeAll'] = $this->MGA_Sarana_Kerja->getCountAsetOfficeAll();
            $data['getMasterAsetOffice'] = $this->MGA_Sarana_Kerja->getMasterAsetOffice();
            $data['getMasterAsetOfficeArea'] = $this->MGA_Sarana_Kerja->getMasterAsetOfficeArea();
            $data['getCountAsetOfficeByKota'] = $this->MGA_Sarana_Kerja->getCountAsetOfficeByKota();

            $this->load->view('Templates/01_Header', $data);
            $this->load->view('Templates/02_Menu');
            $this->load->view('GA_Sarana_Kerja/indexofficearea', $data);
            // $this->load->view('Templates/03_Footer');
            $this->load->view('Templates/99_JS');
    ...
    public function detailOffice()
    {
        ...
        if (!empty($this->session->userdata('id_user'))) {
            ...
            $data['filterURL'] = $decoded_url_area;
            $data['getMasterAsetOffice'] = $this->MGA_Sarana_Kerja->getMasterAsetOffice();
            $data['getMasterAsetOfficeTipe'] = $this->MGA_Sarana_Kerja->getMasterAsetOfficeTipe();

            $this->load->view('Templates/01_Header', $data);
            $this->load->view('Templates/02_Menu');
            $this->load->view('GA_Sarana_Kerja/indexoffice', $data);
            // $this->load->view('Templates/03_Footer');
            $this->load->view('Templates/99_JS');
    ...
    public function tambahAsetKantor()
    {
        ...
        $res = $this->MGA_Sarana_Kerja->tambahAsetKantor($hasil_data);
    ...
    public function editAsetKantor($ao_id_list_office)
    {
        ...
        $res = $this->MGA_Sarana_Kerja->editAsetKantor($hasil_data, $where);
    ...
    public function hapusAsetKantor($ao_id_list_office)
    {
        ...
        $res = $this->MGA_Sarana_Kerja->hapusAsetKantor($ao_id_list_office);
